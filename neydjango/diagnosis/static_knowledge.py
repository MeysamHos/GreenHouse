"""
diagnosis/static_knowledge.py

Static disease knowledge used to pre-seed the DiseaseKnowledge database table.
This is the Django-side copy of ml_service/disease_data.py — kept in sync manually.

Used by knowledge.seed_from_static_data() which is called once at app startup.
"""

STATIC_KNOWLEDGE: dict = {
